...
public class PanelEnBlancoMarcos extends JPanel {
     ...
     * PANEL DE MARCOS
     */
    public PanelEnBlancoMarcos() {
	this.setBounds(0, 0, 1230, 600);
    	setLayout(null);
    	JPanel panelParaScroll = new JPanel();
    	...
    	JPanel panelPrincipalVisible = new JPanel();
    	...
    	JPanel contenedorModulos = new JPanel();
    	...
    	JPanel moduloPlanificacion = new JPanel();
    	...
    	JButton btnBotton = new JButton("Botton");
    	...
    	JButton button_1 = new JButton("Botton");
    	...
    	JButton button_2 = new JButton("Botton");
    	...
    	JButton button_3 = new JButton("Botton");
    	...
    	JLabel lblMduloDePlanificacin = new JLabel("M\u00F3dulo de planificaci\u00F3n");
    	...
    	JButton button_12 = new JButton("Botton");
    	...
    	JLabel lblMduloDeRecursos = new JLabel("M\u00F3dulo de recursos");
    	...
    	JButton button_19 = new JButton("Botton");
    	...
    	JButton button_20 = new JButton("Botton");
    	...
    	JButton button_21 = new JButton("Botton");
    	...
    	JButton button_22 = new JButton("Botton");
    	...
    	JButton button_23 = new JButton("Botton");
    	...
    	JButton button_14 = new JButton("Botton");
    	...
    	JButton button_15 = new JButton("Botton");
    	...
    	JButton button_16 = new JButton("Botton");
    	...
    	JButton button_17 = new JButton("Botton");
    	...
    	JLabel lblMduloDeTipos = new JLabel("M\u00F3dulo de estados y tipos");
    	...
    	JLabel lblMduloDeRespaldos = new JLabel("M\u00F3dulo de respaldos");
    	...
    	JButton button_18 = new JButton("Botton");
    	...
    	JButton button_24 = new JButton("Botton");
    	...
    	JButton button_25 = new JButton("Botton");
    	...
    	JButton button_26 = new JButton("Botton");
    	...
    	JLabel label = new JLabel("M\u00F3dulo administraci\u00F3n");
