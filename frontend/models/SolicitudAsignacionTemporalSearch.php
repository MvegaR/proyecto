...
class SolicitudAsignacionTemporalSearch extends SolicitudAsignacionTemporal
{
    ...
    {
        return [
            [['ID_ASIGNACION_TEMPORAL', 'SOLICITUD_TEMPORAL_PADRE', 'ID_ESTADO_ASIGNACION_TEMPORAL', 'CAPACIDAD_ASIGNACION_TEMPORAL', 'CANTIDAD_BLOQUES_ASIGNACION_TEMPORAL', 'INICIO_BLOQUE_ASIGNACION_TEMPORAL', 'TIPO_SALA_ASIGNACION_TEMPORAL'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'SOLICITUD_TEMPORAL_PADRE' => $this->SOLICITUD_TEMPORAL_PADRE,
