...
class SolicitudAsignacionTemporalSearch extends SolicitudAsignacionTemporal
{
    ...
    {
        return [
            [['ID_ASIGNACION_TEMPORAL', 'ID_ESTADO_ASIGNACION_TEMPORAL', 'CAPACIDAD_ASIGNACION_TEMPORAL', 'CANTIDAD_BLOQUES_ASIGNACION_TEMPORAL'], 'integer'],
            [['DOCENTE_ASIGNACION_TEMPORAL', 'SALA_ASIGNACION_TEMPORAL', 'FECHA_ASIGNACION_TEMPORAL', 'INICIO_BLOQUE_ASIGNACION_TEMPORAL'], 'safe'],
        ];
    }
