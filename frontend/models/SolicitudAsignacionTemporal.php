...
class SolicitudAsignacionTemporal extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ID_ESTADO_ASIGNACION_TEMPORAL', 'CAPACIDAD_ASIGNACION_TEMPORAL', 'CANTIDAD_BLOQUES_ASIGNACION_TEMPORAL', 'TIPO_SALA_ASIGNACION_TEMPORAL', 'SOLICITUD_TEMPORAL_PADRE','ID_ASIGNACION_TEMPORAL','INICIO_BLOQUE_ASIGNACION_TEMPORAL'], 'integer'],
            ...
            [['FECHA_ASIGNACION_TEMPORAL','ID_ESTADO_ASIGNACION_TEMPORAL', 'SOLICITUD_TEMPORAL_PADRE'], 'safe'],
